...
routes['POST']['/wishlists/register'] = 'wishlists#register'
routes['POST']['/wishlists/login'] = 'wishlists#login'
routes['GET']['/wishlists/logout'] = 'wishlists#logout'
routes['GET']['/wishlists/index'] = 'wishlists#index'
routes['GET']['/wishlists/addItemView'] = 'wishlists#addItemView'
routes['POST']['/wishlists/addNewItem'] = 'wishlists#addNewItem'
routes['GET']['/wishlists/deleteInFull/<int:itemid>'] = 'wishlists#deleteInFull'
routes['GET']['/wishlists/deleteFromList/<int:itemid>'] = 'wishlists#deleteFromList'
routes['GET']['/wishlists/addToList/<int:itemid>'] = 'wishlists#addToList'
routes['GET']['/wishlists/viewItem/<int:itemid>'] = 'wishlists#viewItem'
"""
